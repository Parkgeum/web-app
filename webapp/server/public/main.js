...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.login = function (authCredentials) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiBaseUrl + '/member/login', authCredentials);
    };
...
var SignInComponent = /** @class */ (function () {
    ...
    function SignInComponent(userService, _router, _route) {
    ...
    SignInComponent.prototype.btnclick = function () {
