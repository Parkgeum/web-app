    ...
    BoardComponent.prototype.refreshPostList = function () {
        ...
        this.getPostList().subscribe(function (res) {
            ...
            for (i; i < _this.uploadService.upload.length; i++) {
                ...
                var uimg = _this.uploadService.upload[i].image;
                var uhashtag = _this.uploadService.upload[i].hashtag;
...
module.exports = "#lg1 {\r\n    margin: 5px;\r\n    float: left;\r\n}\r\n\r\n#lg2 {\r\n    border-left: 1px solid black;\r\n    padding-left: 40px;\r\n    margin: 20px;\r\n    float: left;\r\n}\r\n\r\n#lg3 {\r\n    margin: 30px;\r\n    float: 0px;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var UserprofileComponent = /** @class */ (function () {
    ...
    UserprofileComponent.prototype.refreshUserList = function () {
        var _this = this;
        this.getUserList().subscribe(function (res) {
            ...
            _this.userService.user = res;
            console.log(_this.userService.user[0].id + _this.userService.user.length);
        });
    };
